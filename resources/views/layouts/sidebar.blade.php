<ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Form Input Data</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link" href="{{ route('mesinro.index') }}">Mesin Ro</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-laporan">
              <ul class="nav flex-column'>
                <li class="nav-item'>
                  <a class="nav-link" href="{{ url('laporan/mesinro')}}">Laporan Mesin Ro</a>
                </li>
              </ul>
            </div>
          </li>
